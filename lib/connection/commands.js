...
Response.prototype.parse = function(options) {
  ...
  if(this.numberReturned == 1 && documentsReturnedIn != null && raw) {
    ...
    // AR: check the doc and doc.cursor for errors (fix from v3.1.1)
    if (doc instanceof Error) throw doc;
    if (doc.errmsg) throw new MongoError(doc.errmsg);
    if (!doc.cursor) throw new MongoError('Cursor not found');
